...
export default class HPNOFPLayout extends HTMLElement {
  async connectedCallback() {
    ...
    try {
      ...
      throw new Error(
        `Failed to read standard layout: ${JSON.stringify(error)}`
      );
    }
    ...
    this.innerHTML = standardLayoutContent;
  }
}
